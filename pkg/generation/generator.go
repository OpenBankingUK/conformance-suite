...
type Generator interface {
	GenerateSpecificationTestCases(discovery discovery.ModelDiscovery, ctx *model.Context) TestCasesRun
}
...
func (g generator) GenerateSpecificationTestCases(discovery discovery.ModelDiscovery, ctx *model.Context) TestCasesRun {
