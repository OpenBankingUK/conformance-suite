...
var (
	accountSpecPath317 = flag.String("spec317", "../v3.1.7/account-info-swagger-flattened.json", "Path to the specification swagger file.")
	...
	accountSpecPath313 = flag.String("spec313", "../v3.1.3/account-info-swagger-flattened.json", "Path to the specification swagger file.")
)
...
func TestBankTransactionCodeSubCode(t *testing.T) {
	...
	t.Run("Transaction with Codes and Subcodes more than 4 chars should PASS 3.1.7 accounts", func(t *testing.T) {
		testCase.Validator, err = schema.NewSwaggerValidator(*accountSpecPath317)
		if err != nil {
			t.Fatal(err)
		}
