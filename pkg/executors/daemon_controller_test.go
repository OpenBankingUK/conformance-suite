...
func TestNewBufferedDaemonControllerAllResults(t *testing.T) {
	...
	result := results.NewTestCaseResult("123", true, results.NoMetrics(), []error{err}, "endpoint", "api-name", "api-version", "detailed description", "https://openbanking.org.uk/ref/uri", "200", "12345")
