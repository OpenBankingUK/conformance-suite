...
| ------------ | ---------------------------------------------------------------------------------------------- |
| v1.9.9-beta1 | v4.0.1 (UI sidebar and discovery templates)                                                    |
| v1.9.8       | v4.0.1                                                                                         |
...
or
    ...
    > docker run --rm -it -p 8443:8443 "openbanking/conformance-suite:v1.9.9-beta1"
