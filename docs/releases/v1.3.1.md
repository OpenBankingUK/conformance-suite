...
---
**Download**: `docker run --rm -it -p 8443:8443 "openbanking/conformance-suite:v1.3.1"` | [DockerHub](https://hub.docker.com/r/openbanking/conformance-suite) | [Setup Guide](https://bitbucket.org/openbankingteam/conformance-suite/src/develop/docs/setup-guide.md)
