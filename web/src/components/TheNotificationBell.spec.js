...
describe('TheNotificationBell.vue', () => {
  ...
  //     return shallowMount(TheNotificationBell, {
  //         store,
  //         localVue,
  //     });
  // };
  ...
  it('when notifications does render', () => {
    // const wrapper = component(stateWithNotifications);
    // expect(wrapper.find('notification-counter').exists()).toBe(true);
  });

  it('when notifications does render correct counter value', () => {
    // const wrapper = component(stateWithNotifications);
    // expect(wrapper.find('.odometer-value').text()).toBe(stateWithNotifications.notifications.length);
  });
});
