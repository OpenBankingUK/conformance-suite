<template>
  <div>
    <!-- <p>Lorem ipsum...</p> -->
    <!-- Leaving for next implementation (discovery endpoint) -->
    <!-- <a-input-search -->
    ...
    <div class="centered">
      <b-jumbotron
        ...
        <p>We are working hard to foster an open and collaborative tool and welcome your feedback to help us develop the best tool.</p>
      ...
      <!-- <router-link to="/wizard" class="go-to-config">Start a validation run</router-link> -->
    </div>
  </div>
</template>
